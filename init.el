...
values."
  (setq-default
   ...
   ;; Paths must have a trailing slash (i.e. `~/.htroycontribs/')
...
values."
  ...
  (setq-default
   ...
   ;; Set private layer directory
   configuration-layer-private-directory "~/.spacemacs.d/layers/"
...
`dotspacemacs/user-config' first."
  ...
  ;; add exec-path for diff.exe
  (add-to-list 'exec-path "~/.spacemacs.d/user-plugin/bin")
  ...
  (setq helm-ag-base-command "~/.spacemacs.d/user-plugin/bin/ag.exe --vimgrep")

  (setq custom-file (expand-file-name "custom.el" dotspacemacs-directory))
  (load custom-file)
  ;; daemon模式下设置字体
  (defun htroy/set-font-indeamon()
...
you should place your code here."
  ...
  ;;test
  (defun htroy/simple-git-commit-push (msg)
  ...
  (defun htroy-org-mode()
    (setq truncate-lines nil)
    (setq pangu-spacing-mode nil))

  (add-hook 'org-mode-hook 'htroy-org-mode)
